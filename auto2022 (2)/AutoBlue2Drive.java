...
@Autonomous(name = "AutoBlue2Drive", group="Autonomous")
public class AutoBlue2Drive extends LinearOpMode { //Locate Special Object
    ...
    double BC_Dist = 60.0;          // Bar Code Distance
    ...
    public void runOpMode() {
        ...
        switch (ARMMOTOR) {
            ...
            case "TETRIX":
                ArmTicksPerRot = 1440;
                ArmLevelTicks = new int[]{50, 235, 525, 750}; // ArmLevelTicks[0] = ticks for level 1, ArmLevelTicks[1] = ticks for level 2, ...
                break;
            default:
        ...
        crab(ToTheSide, 0.20); // 61cm to the right, speed = 25%
        ...
        // *******************************************************************************
        {
            ...
            if (Level == 1)
                speed = 0.15;
            drive(-670, speed); // 50cm away from the wall, speed = 25%
            Step++;
        }
        // *******************************************************************************
        ...
        GrabberOpen = true;
        sleep(1000); // Time for the object to fall out
        drive(60, 0.15);
        // *******************************************************************************
        Grabber.setPosition(ClosedGrabberPos);
        GrabberOpen = false;
